...
{ lib, stdenv, fetchFromGitHub, fetchgit,
  ...
  writeScript, common-updater-scripts, coreutils, git, gnused, nix }:

let
  version = "3.21.0";
  owner = "erlang";
  deps = import ./rebar3-21-deps.nix { inherit fetchFromGitHub fetchgit fetchHex; };
    ...
    passthru.updateScript = writeScript "update.sh" ''
      ...
      PATH=${
        lib.makeBinPath [
          ...
          gnused
          nix
          (rebar3WithPlugins { globalPlugins = []; })
        ]
      }
